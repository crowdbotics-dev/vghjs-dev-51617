"""
Django settings for vghjs_dev_51617 project.
...
ROOT_URLCONF = 'vghjs_dev_51617.urls'
...
WSGI_APPLICATION = 'vghjs_dev_51617.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vghjs_dev_51617 API",
    "DESCRIPTION": "API documentation for vghjs_dev_51617 App",
    "VERSION": "v1",
}
